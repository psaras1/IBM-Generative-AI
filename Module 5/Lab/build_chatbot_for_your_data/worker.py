...
def init_llm():
    ...
    # The WatsonX LM is initialized with the specified parameters and credentials
    llm_hub = WatsonxLLM(model=LLAMA2_model)

    # Initialize embeddings using a pre-trained model to represent the text data.
    # Embeddings are the chunks of the PDF document in numeric vector representation
...
def process_document(document_path):
    ...
    # (Chroma can be used to create and manage embeddings)
...
def process_prompt(prompt):
    ...
    # (conversation_retrieval_chain is used to query the language model)
