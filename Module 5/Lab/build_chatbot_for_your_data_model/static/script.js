/* 
    Responsible for managing the UI and interactions of the application
*/
...
// Sends a post request to the server with the user's message, waits for a response
...
// Removes unnecessary spaces, new lines, tabs and HTML tags from the user's input
...
const populateBotResponse = async (userMessage) => {
  ...
  if (isFirstMessage) {
    ...
    // Event listener, handles upload process
