...
credentials = {
    ...
    #"apikey": "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"
}
...
def speech_to_text(audio_binary):
    ...
    # Points to Watson's Speech-to-Text service
    api_url = base_url+'/speech-to-text/api/v1/recognize'

    # Set up parameters for our HTTP reqeust
    params = {
        # Tells Watson that we want to use the US English model for processing our speech
...
def watsonx_process_message(user_message):
    ...
    print("Response from Watsonx API: ", response_text)
